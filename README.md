...
- <p>Transaction_Branch(Transaction_ID integer (foreign key references Transaction.Transaction_ID), Branch_ID integer (foreign key references  Branch\.Branch\_ID))</p>
...
- <p>Branch_Employee(Branch_ID integer (foreign key references Branch\.Branch\_ID), Employee_ID integer (foreign key references Employee.Employee_ID))</p>
- <p>Branch_Manager(EmployeeID integer (foreign key references Employee.Employee_ID), Branch_ID integer (foreign key references Branch\.Branch\_ID), Branch_Manager varchar(255))</p>
